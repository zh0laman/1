...
- `C:\Users\skydy\GolandProjects\messenger\internal\service\e2ee_service.go`
- `C:\Users\skydy\GolandProjects\messenger\internal\repository\e2ee_repository.go`
- `C:\Users\skydy\GolandProjects\messenger\internal\handler\e2ee_handler.go`
...
- `C:\Users\skydy\GolandProjects\messenger\internal\service\e2ee_service.go`
- `C:\Users\skydy\GolandProjects\messenger\internal\service\e2ee_contract.go`
...
- миграцией `20260405113000_add_kdf_params_to_user_key_backups.sql`
...
- этот тип legacy backup unsupported для password-based restore
- supported path only:
  - `fresh web key`
  - `QR + history sync`
...
5. Если contract не подтверждается, пересохранить backup через trusted device или признать format unsupported.
6. После этого обновить docs, чтобы current backend truth не притворялась stronger guarantee, чем она реально дает для legacy rows.
